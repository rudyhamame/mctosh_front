...
const AboutContentAR = () => (
  <>
    ...
    <section id="about-what" className="about_section">
      <h2 className="about_section_title">ما هو MCTOSHS؟</h2>
      <p className="about_section_body">
        MCTOSHS هو نظام منظَّم ومتمحور حول المريض لاستخراج الهيولات وتصنيفها. صُمم لتحديد الكيانات المرتبطة بالسريريات وتنظيمها عبر المقاييس المختلفة؛ ويشمل الكيانات غير البيولوجية، مثل أدوات التشخيص والأجهزة والإجراءات، والكيانات البيولوجية، من البنى دون الجزيئية إلى المريض كاملًا، مع إبقاء المريض في مركز كل قرار تصنيفي.
      </p>
    </section>
    ...
    <section id="about-pivotal" className="about_section about_section--pivotal">
      ...
      <p className="about_section_body">
        في هذه المرحلة، تمثل اللغة المصدر الوحيد المتاح للهيولات. يستخرج MCTOSHS الهيولات من النصوص السريرية والعلمية — ملفات PDF، والأدبيات، والتقارير — لا مباشرة من المرضى. لا تُعامل اللغة هنا بوصفها الواقع النهائي، بل بوصفها تقريبًا أوليًا ضروريًا: الوسيط الوحيد الذي يمكن من خلاله تحديد الكيانات السريرية وتنظيمها قبل إتاحة الوصول المباشر إلى المرضى.
      </p>
      <p className="about_section_body" style={{ marginTop: "0.75rem" }}>
        هذا الاستخراج من اللغة <strong>خطوة تحضيرية</strong>. فالغاية الحقيقية لـ MCTOSHS هي تجاوز النص، واللقاء بالمرضى الحقيقيين، وبناء وصف منظَّم للظواهر الذاتية انطلاقًا من خبرتهم المعيشة: ما يراه المريض، ويسمعه، ويشعر به، ويتذوقه، ويشمه فيما يتصل بحالته. والهيولات المستخرجة من اللغة تؤسس الأرضية المفهومية التي تجعل هذه المقابلة ذات معنى ومنظَّمة.
      </p>
      <p className="about_section_body" style={{ marginTop: "0.75rem" }}>
    ...
    <section id="about-means" className="about_section">
      ...
      <p className="about_section_body">
        وسيلة الوصول هي أي قناة تصل المراقب بآثار الواقع السريري، لا بالواقع السريري نفسه، إذ لا يستطيع أي مراقب بلوغه مباشرة. يعمل هذا المفهوم في MCTOSHS على ثلاثة مستويات في آن واحد: إبستيمي، وظاهراتي، وبنيوي. وفهم المستويات الثلاثة ضروري لفهم ما يفعله النظام ولماذا يفعله.
      </p>
      ...
      <div className="about_means_level">
        ...
        <div className="about_means_level_body">
          ...
          <p className="about_section_body about_section_body--callout">
            لا يملك MCTOSHS عينين، ولا أذنين، ولا لسانًا، ولا جلدًا، ولا أنفًا. كل ما يملكه هو نص رقمي؛ واللغة نفسها هي بالفعل تحويل لشيء حدث في جسم، وفي غرفة، وبين طبيب ومريض.
          </p>
          ...
          <p className="about_section_body" style={{ marginTop: "0.75rem" }}>
            <strong>MCTOSHS مراقب متوسَّط باللغة.</strong> لا يمكنه ملاحظة الآثار مباشرة لأنه بُني كليًا بواسطة أنظمة بشرية ولا يملك جهازًا حسيًا خاصًا به. وكل ما يعرفه عن الواقع السريري يأتي عبر لغة أنتجها بشر لاحظوا الآثار بالفعل. والسلسلة الإبستيمية هي:
          </p>
          <ol className="about_trace_chain">
            ...
            <li><strong>MCTOSHS</strong> — يقرأ اللغة؛ وهو مراقب متوسَّط باللغة لملاحظات آثار</li>
          </ol>
          <p className="about_section_body" style={{ marginTop: "0.75rem" }}>
            وينتج عن ذلك معنى هادئ لكنه عميق بالنسبة لتصنيف البطاقات. فبطاقة <strong>الأشياء</strong> لا تخزن الأشياء ذاتها؛ بل تخزن استدلالات مسمّاة مشتقة من الآثار. وما يسميه MCTOSHS «شيئًا» هو دائمًا بناء: كيان مفترض لتفسير الآثار التي لوحظت. وبطاقة <strong>الآثار</strong> هي، بهذا المعنى، أولى إبستيميًا، لأنها أقرب إلى ما يواجهه أي مراقب فعليًا. أما الأشياء فهي دائمًا على بُعد خطوة إضافية.
          </p>
          <p className="about_section_body" style={{ marginTop: "0.75rem" }}>
            أما وسيلة الوصول الثانية والأعمق فهي <strong>لقاء المريض</strong> — لقاء مباشر، متجسد، ومتموضع في سياقه. وإلى هناك يتجه MCTOSHS: ليس لتجاوز اللغة، بل للاقتراب من الآثار نفسها قبل أن تكون اللغة قد قررت معناها مسبقًا.
          </p>
        </div>
      </div>
      ...
      <div className="about_means_level">
        ...
        <div className="about_means_level_body">
          ...
          <p className="about_section_body">
            تمثل وسيلة الوصول أيضًا الرابط البنيوي بين مرحلتي MCTOSHS. فالهيولى المستخرجة من اللغة — مثل <em>إحساس بالحرقان</em> — تبقى غير مثبتة. إنها فئة بلا ذات. لكن حين يقول المريض: <em>نعم، ذلك الإحساس عندي، أشعر به عبر جلدي، وهو مستمر، ويزداد ليلًا</em>، لا تعود الهيولى مادة غير متمايزة. لقد أُعطيت صورة من خلال قناة حسية محددة، وجسد محدد، وزمن محدد.
          </p>
          <p className="about_section_body" style={{ marginTop: "0.6rem" }}>
            وسيلة الوصول — العين، والأذن، واللسان، والجلد، والأنف — هي تحديدًا ما يحول الهيولى المصنفة إلى <strong>ظاهرة معيشة</strong>. ولهذا توجد بطاقة «الظواهر» بوصفها وجهة منفصلة في MCTOSHS: لا لتخزين ما تقوله النصوص إن المرضى يشعرون به، بل لتسجيل ما يذكر هذا المريض أنه يشعر به، وعبر أي حاسة، وبأي كيفية، وعلى أي مقياس من جسده.
          </p>
        </div>
      </div>
    </section>
